...
with col1:
    ...
    purchase_price = st.number_input("💰 Price ($)", value=50000.00, min_value=50000.00, max_value=2000000.00, step=5000.00, format="%.2f")

with col2:
    loan_term = st.number_input("📆 Term (Years)", value=30.00, min_value=5.00, max_value=30.00, step=5.00, format="%.0f")
    interest_rate = st.number_input("📊 Interest (%)", value=5.625, min_value=1.0, max_value=10.0, step=0.001, format="%.3f")

with col3:
    property_tax = st.number_input("🏡 Tax ($)", value=0.00, min_value=0.00, max_value=50000.00, step=0.01, format="%.2f")
    home_insurance = st.number_input("🔒 Insurance ($)", value=0.00, min_value=0.00, max_value=20000.00, step=0.01, format="%.2f")
    flood_insurance = st.number_input("🌊 Flood Ins. ($)", value=0.00, min_value=0.00, max_value=20000.00, step=0.01, format="%.2f")
