...
def calculate_loan(purchase_price, loan_term, interest_rate, formula, property_tax, home_insurance, flood_insurance):
    ...
    return total_sale_price, loan_amount, cash_to_close, monthly_payment, total_monthly_payment  # Only return necessary values
...
if st.button("📊 Calculate Loan & Monthly Payment"):
    ...
    if loan_amount > max_loan_limit:
        ...
        st.markdown(
    f"💡 **Your Options:**\n"
    f"- Increase your down payment
    to **{adjusted_down_payment:.2f}%**\n"
