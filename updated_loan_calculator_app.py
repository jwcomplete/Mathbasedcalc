...
# Define loan formulas and max limits
loan_formulas = {
    "C.3.0": {"down_payment": 3, "seller_concession": 0, "max_ltv": 97},
    "C.3.3": {"down_payment": 3, "seller_concession": 3, "max_ltv": 97},
    "C.5.0": {"down_payment": 5, "seller_concession": 0, "max_ltv": 95},
    "C.5.3": {"down_payment": 5, "seller_concession": 3, "max_ltv": 95},
    "C.10.0": {"down_payment": 10, "seller_concession": 0, "max_ltv": 90},
    "C.10.6": {"down_payment": 10, "seller_concession": 6, "max_ltv": 90},
    "C.15.0": {"down_payment": 15, "seller_concession": 0, "max_ltv": 85},
    "C.15.2": {"down_payment": 15, "seller_concession": 2, "max_ltv": 85},
    "C.15.6": {"down_payment": 15, "seller_concession": 6, "max_ltv": 85},
    "C.20.0": {"down_payment": 20, "seller_concession": 0, "max_ltv": 80},
    "C.20.2": {"down_payment": 20, "seller_concession": 2, "max_ltv": 80},
    "C.20.6": {"down_payment": 20, "seller_concession": 6, "max_ltv": 80},
    "C.25.0": {"down_payment": 25, "seller_concession": 0, "max_ltv": 75},
    "C.25.2": {"down_payment": 25, "seller_concession": 2, "max_ltv": 75},
    "C.25.6": {"down_payment": 25, "seller_concession": 6, "max_ltv": 75},
    "C.25.9": {"down_payment": 25, "seller_concession": 9, "max_ltv": 75},
    "HB.10.0": {"down_payment": 10, "seller_concession": 0, "max_ltv": 90},
    "HB.10.6": {"down_payment": 10, "seller_concession": 6, "max_ltv": 90},
    "HB.15.0": {"down_payment": 15, "seller_concession": 0, "max_ltv": 85},
    "HB.15.6": {"down_payment": 15, "seller_concession": 6, "max_ltv": 85},
    "HB.20.0": {"down_payment": 20, "seller_concession": 0, "max_ltv": 80},
    "HB.20.6": {"down_payment": 20, "seller_concession": 6, "max_ltv": 80},
    "HB.25.0": {"down_payment": 25, "seller_concession": 0, "max_ltv": 75},
    "HB.25.6": {"down_payment": 25, "seller_concession": 6, "max_ltv": 75},
    "HB.25.9": {"down_payment": 25, "seller_concession": 9, "max_ltv": 75}
}

max_loan_limit = 806500.00  # Conforming loan limit for 1-unit property
...
with col2:
    ...
    interest_rate = float(st.number_input("📊 Interest Rate (%)", min_value=1.0, max_value=10.0, step=0.001, value=5.625))
...
if st.session_state.button_clicked:
    ...
    if loan_amount > max_loan_limit:
        ...
        st.markdown(f"💡 **Your Options:**")

        # Button for increasing down payment and recalculating
        if st.button(f"✅ Apply {adjusted_down_payment:.2f}% Down Payment & Recalculate - Total Cash to Close: ${new_cash_to_close:,.2f}"):
            st.session_state.adjusted_down_payment = adjusted_down_payment
            st.session_state.new_cash_to_close = new_cash_to_close

            # Recalculate with the new down payment
