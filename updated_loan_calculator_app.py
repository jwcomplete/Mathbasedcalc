...
loan_formulas = {
    ...
    "C.5.3 Low out of pocket w/BETTER RATEST! 5% down with 3% Seller credit towards some or all closing cost": {"down_payment": 5, "seller_concession": 3, "max_ltv": 95},
    ...
    "C.25.2 Investment property 20% down with 2% seller credit towards closing cost": {"down_payment": 25, "seller_concession": 2, "max_ltv": 75},
